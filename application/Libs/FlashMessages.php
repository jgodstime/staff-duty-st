<?php
namespace Mini\Libs; //mine
// namespace Plasticbrain\FlashMessages; //default namespace
...
class FlashMessages {
    ...
    protected $cssClassMap = [ 
        ...
        //my error with boostrap close button the success-msg is the class for my css 
        self::ERROR   => 'danger-msg',
